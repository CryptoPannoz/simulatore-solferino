...
- **Repo**: `CryptoPannoz/simulatore-solferino` (privata — contiene dati economici personali)
- **Deploy**: nessuno; si apre `index.html` in locale. Zero dipendenze, un solo file.
- **Clasp**: non usato.
